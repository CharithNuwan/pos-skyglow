...
export async function POST(req: NextRequest) {
  try {
    ...
    const { barcode, product_name, category_id, cost_price, selling_price, quantity, minimum_stock, description } = data;
    ...
    const result = await execute(
      ...
      [barcode || null, product_name, category_id || null, cost_price, selling_price, quantity, minimum_stock || 5, description || null]
    );
